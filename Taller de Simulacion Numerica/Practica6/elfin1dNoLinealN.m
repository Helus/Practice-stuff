function [x,phi]=elfin1dNoLinealN(fp,fdp,fr,fq,ff,p,a,b,datos_a,datos_b,nel,l,iopcoef,iopblo,tol,maxit)
...
for i=1:maxit
    ...
    [x,phi]=elfin1dns(fpN,fdpN,fr,fqN,ff,a,b,datos_a,datos_b,nel,l,iopcoef,iopblo); 
