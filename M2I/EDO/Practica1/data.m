...
% Valor de theta
theta=0.6; % theta entre 0 y 1 
fprintf(ofi,'\n\n* Valor de theta: \n theta = %-.5E.', theta);

% Método de resolución del sistema
sistSol=false; % Newton: true , Punto fijo: false
if sistSol
    eleccion='Método de Newton';
else
    eleccion='Método de punto fijo';
end
fprintf(ofi,'\n\n* Método escogido para la resolución del sistema: %s', eleccion);
